...
class Trip {
    ...
    private void addRoad(String from, String name, double length,
        ...
        Road oppRoad = new Road(name, dir.reverse(), length);
        _map.add(v0, v1, newRoad);
        _map.add(v1, v0, oppRoad);
    }
    ...
    private class TripPlan extends SimpleShortestPaths {
        ...
        protected double getWeight(int u, int v) {
            Road roadUV = _map.getLabel(u, v);
            return roadUV.length();
        }

        @Override
        protected double estimatedDistance(int v) {
            Location vLocation = _map.getLabel(v);
            return vLocation.dist(_finalLocation);
        }
